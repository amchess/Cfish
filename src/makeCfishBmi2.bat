...
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-485.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-493.exe
...
@echo off
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-494.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-540.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-620.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-630.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-640.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-710.exe
...
mingw32-make -f MakeFile build ARCH=x86-64-bmi2 COMP=mingw
strip cfish.exe
ren cfish.exe Cfish9-x86-64-bmi2-720.exe
make clean
